<footer id="footer" class="footer footer-1 text-center">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-4">
                    <div class="footer--widget-content">
                        <h3>Our address</h3>
                        <p>
                            Avenue Road Section:2 , Block: A, Avenue:1 ,<br />
                            House: 12/1, Dhaka 1216
                        </p>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="row reservation">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="reservation-link text-center"><span class="text-white">Reservation Powered by</span> <a href="#">Opentable</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="footer--copyright text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12"><span>&copy; 2022, With Love by </span> <a href="#">BUBT</a></div>
            </div>
        </div>
    </div>
</footer>
